...
SRC_URI="https://github.com/feather-wallet/feather/archive/refs/tags/${PVR}.tar.gz -> ${PF}.tar.gz
	https://github.com/tevador/polyseed/archive/${POLYSEED_DIST_COMIT}.zip -> ${PF}-polyseed.zip
	https://github.com/itay-grudev/SingleApplication/archive/${SINGLEAPPLICATION_DIST_COMIT}.zip -> ${PF}-singleapplication.zip
